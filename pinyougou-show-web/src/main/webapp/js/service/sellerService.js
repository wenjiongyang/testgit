...
app.service('sellerService',function($http){
	...
	this.updatePwd=function(entity){
		return $http.post('../seller/updatePwd.do',entity);
	}
	//查并判断密码
	this.findPwdBySellerId=function(entity){
		return $http.post('../seller/findPwdBySellerId.do',entity);
	}
	//修改商家数据
	this.updateAll=function(entity){
		return $http.post('../seller/updateAll.do',entity);
	}
});
