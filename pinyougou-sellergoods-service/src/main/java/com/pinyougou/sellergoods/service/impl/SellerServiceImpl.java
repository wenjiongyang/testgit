...
public class SellerServiceImpl implements SellerService {
	 ...
	 */
	@Override
	public void updatePwd(TbSeller seller){
	 ...
	 * 查密码
	 */
	public String findPwdBySellerId(String sid){
		String pwdBySellerId = sellerMapper.findPwdBySellerId(sid);
		return pwdBySellerId;
	}
}
